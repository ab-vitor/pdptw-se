...
def is_precede_possible(
    ...
    # arrival_time_at_f_h_i = inst.eprime[i] + inst.s[i] + inst.d_bar_min[i, h]
    # arrival_machine_at_f_h_i = (
    #     inst.lprime[jprime]
    #     - inst.d_bar_min[jprime, h]
    #     + inst.O[inst.f[jprime][h], inst.f[i][h], h]
    # )
    # iprime_jprime_must_precede_i_j = arrival_time_at_f_h_i >= arrival_machine_at_f_h_i
    # if iprime_jprime_must_precede_i_j:
    #     return False
    return True
...
def is_precede_possible_ppd(
    ...
    # iprime_jprime_must_precede_i_j = arrival_time_at_f_h_i >= arrival_machine_at_f_h_i
    # if iprime_jprime_must_precede_i_j:
    #     inst.ppd.infeas_gamma_vars_is_iprime_jprime_must_precede_i_j += 1
    #     return False
    return True
