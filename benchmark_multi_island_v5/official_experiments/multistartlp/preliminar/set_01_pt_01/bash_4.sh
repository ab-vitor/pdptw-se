...
run_experiment() {
    ...
    local EXE_PARAMS="--inst $instpath ${CONFIG_PARAMS} --cutoff_machs ${com} --seed ${seed}"
...
for seed_id in {1..10};do
    ...
    for inst in "${insts[@]}"; do
        ...
        for alpha in 0.20;do
            ...
            CONFIG_PARAMS="--genconfigfile ${gen_config_file} --output ${output} --alpha ${alpha} --suff_csv _${bash_id} --suff_outputs _seed_${seed}_alpha_${alpha_name}"
