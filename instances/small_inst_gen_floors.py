...
def gen_inst_files(filename, group, new_group):
    ...
    if mf != "none":
        ...
        cmd_str = f"julia pdptwse.jl --methodType heur --methodCode {mf} --inst ../../instances/{new_group}/{type_code}/{filename}/ --make_instance_feasible --elevator --cutoffmachs {min_n_machines}"
